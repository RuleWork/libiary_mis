...
public class OrgType {
	...
	public OrgType(String orgTypeName, String orgTypeMemo) {
		super();
	...
	public String toString() {
		return "OrgType [orgTypeId=" + orgTypeId + ", orgTypeName=" + orgTypeName + ", orgTypeMemo=" + orgTypeMemo
				+ "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((orgTypeMemo == null) ? 0 : orgTypeMemo.hashCode());
		result = prime * result + ((orgTypeName == null) ? 0 : orgTypeName.hashCode());
		return result;
	}
